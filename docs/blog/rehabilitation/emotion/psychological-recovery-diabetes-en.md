...
In the recovery phase, many people hit a “this shouldn’t be hard—but it is” problem:

**You already know what to eat, how to move, and how to sleep—yet sustaining it long-term feels difficult.**

That doesn’t mean you lack discipline. Recovery shifts the challenge from **knowledge** to **systems**:
...
This guide gives you an actionable psychological recovery framework to:

1) reduce the mental cost of consistency
...
## 1) The recovery-phase mindset shift: not “should I persist?” but “how do I make it easier?”

During treatment, urgency can carry you: labs, targets, “I must fix this.” In recovery, the horizon is longer and life continues—work, family, travel, stress.

So recovery isn’t about pushing harder. It’s about improving the system:
...
In real life, imperfection is guaranteed. Recovery needs an “engineering” mindset: allow variance, keep it bounded, learn from it.
...
In recovery, the most effective strategy isn’t making huge decisions daily—it’s reducing how often you need to decide.
...
The “best” recovery isn’t never slipping—it’s having a plan.

### 5.1 The 3-step containment method (works for any slip)

1) **Acknowledge**: a deviation happened; it’s human
2) **Contain**: keep it to one meal/day
3) **Restore**: next meal returns to default structure (vegetables + protein first)

### 5.2 Weekly review: only three questions

10–15 minutes per week:

1) What was the most typical deviation, and what state preceded it (hungry, tired, stressed, social)?
2) What tiny early action would reduce risk next time (protein snack, earlier sleep, prepared option)?
3) If I change only one variable next week, what is most likely to work?
...
Many people start with emotion-driven motivation (“I have to change”). But emotion fluctuates. Recovery needs steadier sources:
...
1) What state was I in (hungry, tired, stressed, emotional)?
2) What need was that behavior trying to meet?
3) Next time, how can I meet the same need more safely?
...
Support isn’t a sign of weakness—it’s part of the recovery system.

---

## Related reading (internal links)

- [Recovery: Long-term diet strategy](./../diet/)
- [Recovery: Exercise for rebuilding capacity](./../exercise/)
- [Recovery: Sleep repair](./../sleep/)
- [Treatment: Stress and emotion management](./../../treatment/emotion/)
