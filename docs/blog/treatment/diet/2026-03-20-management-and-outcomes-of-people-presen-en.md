...
- Red, swollen, or warm skin around the damaged area
- Pus or foul-smelling drainage from a wound
- Increased tenderness or pain (though many people with neuropathy feel no pain at all)
- Red streaks spreading up from the foot
...
## Step-by-Step Management Plan for New Diabetes-Related Foot Infections (Backed by Prospective Research)
...
- Call your primary care provider, endocrinologist, or podiatrist immediately, and tell them you have diabetes and suspect a new foot infection. If they can’t see you same day, go to an urgent care clinic with experience treating diabetes patients.
- Bring a list of all your current medications, recent blood sugar logs, and details about when you first noticed symptoms, plus any known injury that may have caused the issue (e.g., blister from new shoes, cut from a garden thorn).
- Do not attempt to pop blisters, drain pus, or apply over-the-counter antiseptics before your appointment, as this can push infection deeper.
...
**Specific actions to take**:
- Your provider will likely order 3 core tests for a new DFI: 1) a wound swab to identify the exact bacteria causing the infection, so you get the right antibiotic, 2) an X-ray to check if infection has spread to the bone, and 3) blood tests to measure inflammation levels and average recent blood sugar control.
- Ask your provider to explain what each test is checking for, and when you can expect results.
...
**Specific actions to take**:
- If prescribed oral antibiotics, take every dose as scheduled, even if your foot looks and feels better after 3-5 days. Stopping antibiotics early allows antibiotic-resistant bacteria to grow, leading to recurrent, harder-to-treat infections.
- If your provider performs debridement (removal of dead, infected tissue from the wound), keep the dressing clean and dry until your next scheduled change, and avoid getting the wound wet in the shower or bath.
- If prescribed IV antibiotics, attend all scheduled infusion appointments, even if you feel fine.
...
**Specific actions to take**:
- Check your blood sugar 2-3 times per day (fasting, 2 hours after meals, and before bed) to keep levels in the target range: 80-130 mg/dL before meals, and under 180 mg/dL 2 hours after eating.
- If your blood sugar is consistently over 200 mg/dL for 2+ days, contact your endocrinologist immediately to adjust your insulin or oral diabetes medication dose.
- Cut back on refined carbs (white bread, pastries, sugary drinks, fried snacks) that spike blood sugar, and prioritize high-fiber, protein-rich meals to support immune function and healing.
...
**Specific actions to take**:
- Use crutches, a walking boot, or a wheelchair as directed by your provider to avoid putting pressure on the infected foot. Walking on an infected foot can push bacteria deeper into tissue, slow healing, and increase risk of tissue death.
- Attend all scheduled follow-up appointments, which are usually every 1-2 weeks initially to check wound healing, adjust dressings, and modify treatment if needed.
...
**Specific actions to take**:
- Get a comprehensive foot exam from a podiatrist every 3 months to catch early signs of neuropathy, calluses, or foot deformities that increase infection risk.
- Wear properly fitted diabetic shoes and moisture-wicking, seamless socks at all times, even inside your home, to avoid blisters and cuts.
- Moisturize your feet daily (avoiding the area between your toes) to prevent dry, cracked skin that can let bacteria enter.
...
### Q1: Can I treat a small new diabetes-related foot infection at home with over-the-counter antibiotic cream?
...
### Q3: How long does it take for a new diabetes-related foot infection to heal completely?
...
### Q4: Will I need to be admitted to the hospital for a new diabetes-related foot infection?
