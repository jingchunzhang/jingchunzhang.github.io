...
- recovery is worse after poor sleep;
...
2) take a short top‑up inhale
3) exhale slowly and long
...
2) the hardest thing today
3) one small change tomorrow
...
1) prioritize clinician/guidelines
2) trust your own data
3) aim for sustainable small improvements, not a perfect one‑shot plan
...
1) tell one trusted person what support you need (understanding, not policing)
2) join a high‑quality peer group (avoid rumor/anxiety contagion)
3) externalize your plan (a note on fridge/phone) so environment reminds you
...
1) fix sleep basics
2) stabilize plate structure
3) add post‑meal light activity
4) then optimize training and fine‑tuning
