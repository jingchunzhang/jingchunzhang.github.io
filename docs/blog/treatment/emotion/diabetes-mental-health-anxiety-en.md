...
description: "diabetes mental health: coping with anxiety and depression - Comprehensive guide"
categories: ["treatment", "emotion"]
tags: ["糖尿病", "健康", "预防"]
author_id: "zzh"
author_name: "zzh"
...
slug: "diabetes-mental-health-anxiety-en"
---
...
- **Join a diabetes support group**: Online (e.g., [JDRF support groups](https://www.jdrf.org/)) or in-person (check local hospitals). Shared experiences reduce isolation.  
...
- **Crisis hotlines**: If you feel hopeless, call the [National Suicide Prevention Lifeline](https://988lifeline.org/) or your local crisis line.  
...
A: Schedule a calm chat: *“I need you to listen when I’m anxious, not fix it. When I say, ‘I’m stressed,’ just say, ‘I’m here.’”* You can also share resources (like [this guide for partners](https://www.ada.org/)).  
